  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="petugas.php">Admin PLN</a> 
      </div>
      <div style="color: white;padding: 15px 20px 15px 20px;float: right;font-size: 16px;"> 
        ...
        <a href="petugas.php?page=logout" class="btn btn-danger square-btn-adjust">Logout</a> 
      </div>
    </nav>   
<!-- /. NAV TOP  -->
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
            <a  class="active-menu" href="petugas.php"><i class="fa fa-dashboard"></i> Dashboard</a>
          </li> 
          <li>
            <a  href="petugas.php?page=petugas"><i class="fa fa-qrcode"></i> Data Petugas</a>
          </li>
          <li>
          <li>
            <a  href="petugas.php?page=pelanggan"><i class="fa fa-qrcode"></i> Data Pelanggan</a>
          </li>
          <li>
          <li>
            <a  href="petugas.php?page=tagihan"><i class="fa fa-qrcode"></i> Data Tagihan</a>
          </li>
          <li>
          <li>
            <a  href="petugas.php?page=pembayaran"><i class="fa fa-qrcode"></i> Data Pembayaran</a>
          </li>
          <li>
          <li>
            <a  href="petugas.php?page=tarif"><i class="fa fa-qrcode"></i> Data Tarif</a>
          </li>
          <li>
            ...
            <ul class="nav nav-second-level">
              <li>
                <a  href="petugas.php?page=edituserlist"><i class="fa fa-user"></i> Edit User</a>
              </li>
              <li>
                <a  href="petugas.php?page=importuser"><i class="fa fa-home"></i> Import Users</a>
              </li>
            </ul>
          </li>
      </div>      
